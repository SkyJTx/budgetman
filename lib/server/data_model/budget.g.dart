...
const BudgetSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'routineInterval': PropertySchema(
      id: 7,
      name: r'routineInterval',
      type: IsarType.long,
    ),
...
void _budgetSerialize(
  ...
  writer.writeBool(offsets[4], object.isRemoved);
  writer.writeBool(offsets[5], object.isRoutine);
  writer.writeString(offsets[6], object.name);
  writer.writeLong(offsets[7], object.routineInterval);
...
Budget _budgetDeserialize(
  ...
  final object = Budget(
    ...
    routineInterval: reader.readLongOrNull(offsets[7]),
...
extension BudgetByIndex on IsarCollection<Budget> {
  Future<Budget?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  Budget? getByNameSync(String name) {
  ...
  Future<List<Budget?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<Budget?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(Budget object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(Budget object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<Budget> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<Budget> objects, {bool saveLinks = true}) {
...
extension BudgetQueryWhereSort on QueryBuilder<Budget, Budget, QWhere> {
  ...
  QueryBuilder<Budget, Budget, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetQueryWhere on QueryBuilder<Budget, Budget, QWhereClause> {
  ...
  QueryBuilder<Budget, Budget, QAfterWhereClause> nameGreaterThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterWhereClause> nameLessThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterWhereClause> nameBetween(
    String lowerName,
    String upperName, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Budget, Budget, QAfterWhereClause> nameStartsWith(
      String NamePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'name',
  ...
  QueryBuilder<Budget, Budget, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<Budget, Budget, QAfterWhereClause> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension BudgetQueryFilter on QueryBuilder<Budget, Budget, QFilterCondition> {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> isCompletedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> isRemovedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> isRoutineEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> routineIntervalIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'routineInterval',
      ));
    });
  }

  QueryBuilder<Budget, Budget, QAfterFilterCondition>
      routineIntervalIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> routineIntervalEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'routineInterval',
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> routineIntervalLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> routineIntervalBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BudgetQuerySortBy on QueryBuilder<Budget, Budget, QSortBy> {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> sortByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByIsCompletedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.desc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByIsRemoved() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRemoved', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByIsRemovedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRemoved', Sort.desc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByIsRoutine() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRoutine', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByIsRoutineDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> sortByRoutineInterval() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'routineInterval', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByRoutineIntervalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'routineInterval', Sort.desc);
    });
  }
...
extension BudgetQuerySortThenBy on QueryBuilder<Budget, Budget, QSortThenBy> {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> thenByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByIsCompletedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.desc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByIsRemoved() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRemoved', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByIsRemovedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRemoved', Sort.desc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByIsRoutine() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRoutine', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByIsRoutineDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRoutine', Sort.desc);
    });
  }
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> thenByRoutineInterval() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'routineInterval', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByRoutineIntervalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'routineInterval', Sort.desc);
    });
  }
...
extension BudgetQueryWhereDistinct on QueryBuilder<Budget, Budget, QDistinct> {
  ...
  QueryBuilder<Budget, Budget, QDistinct> distinctByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isCompleted');
    });
  }

  QueryBuilder<Budget, Budget, QDistinct> distinctByIsRemoved() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isRemoved');
    });
  }

  QueryBuilder<Budget, Budget, QDistinct> distinctByIsRoutine() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QDistinct> distinctByRoutineInterval() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'routineInterval');
    });
  }
...
extension BudgetQueryProperty on QueryBuilder<Budget, Budget, QQueryProperty> {
  ...
  QueryBuilder<Budget, bool, QQueryOperations> isCompletedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isCompleted');
    });
  }

  QueryBuilder<Budget, bool, QQueryOperations> isRemovedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isRemoved');
    });
  }

  QueryBuilder<Budget, bool, QQueryOperations> isRoutineProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, int?, QQueryOperations> routineIntervalProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'routineInterval');
    });
  }
